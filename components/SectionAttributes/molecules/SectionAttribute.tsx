    ...
    <>
      ...
      <div className="grid grid-cols-6 gap-x-2 mt-2 xs:mt-6 mb-1">
        ...
        <div className="col-span-6 sm:col-span-4 lg:col-span-3">
          <Form.Item
            ...
            tooltip={{
              placement: 'topLeft',
              title:
                'Specify how this attribute will be displayed when creating or updating a trip',
              icon: <InfoCircleOutlined />,
            }}
          >
            <Select showSearch defaultValue="input" onChange={setEditValue}>
        ...
        <div className="col-span-6 sm:col-span-4 lg:col-span-3 lg:mr-5">
          ...
          >
            <Select showSearch defaultValue="label" onChange={setViewValue}>
